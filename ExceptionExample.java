 ...
 * The catch block contains the code that says what to do if exception occurs.This problem will test your knowledge on try-catch block.
 * 
 * You will be given two integers x and y as input, you have to compute x/y. If  and  are not  bit signed integers or if  is zero, 
